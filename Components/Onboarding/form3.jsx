    ...
    return (
        <div className="w-full">
            ...
            <form action="#">
                ...
                <div className="flex">
                    <a href="#" className="sm:py-3 py-2 text-[#111827] hover:text-primary-600 dark:text-[#9CA3AF] dark:bg-[#1F2937] font-medium text-sm text-center bg-white border-[1px] rounded-lg items-center w-full border-[#E5E7EB] dark:border-[#4B5563] focus:ring-2 dark:focus:ring-offset-gray-800 dark:hover:bg-[#374151] hover:bg-gray-100">Prev: Personal Info</a >
                    <button type="submit" className="bg-primary-600 hover:bg-primary-700 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 w-full rounded-lg items-center ml-3 font-medium text-center px-5 text-sm">Next: Account Info</button>
                </div>
            </form>
        </div>
    )
