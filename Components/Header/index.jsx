                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link href="/">
                        <div className="flex items-center hover:cursor-pointer">
                            ...
                            <span className="self-center text-xl font-semibold whitespace-nowrap text-black dark:text-white">GambleBee</span>
                        </div>
                    </Link>
                    {auth.loading ? <></> : <div className="flex items-center lg:order-2">
                        <Toggle />
                        {auth.user ? <div onClick={handlelogout} className="text-gray-800 border-[1px] border-gray-600 hover:cursor-pointer dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Log out</div> :
                    ...
                    {/* <div className={classNames(showMenu ? "block" : "hidden", "justify-between items-center w-full lg:flex lg:w-auto lg:order-1")} id="mobile-menu-2">
